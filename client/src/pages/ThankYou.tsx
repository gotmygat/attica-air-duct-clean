      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-lg bg-[#1a1a1a] rounded-2xl shadow-2xl p-10 text-center">
          ...
          <div className="flex items-center justify-center mb-6">
            <div className="w-20 h-20 rounded-full bg-[oklch(0.54_0.135_232.9)]/15 flex items-center justify-center">
              <CheckCircle size={44} className="text-[oklch(0.54_0.135_232.9)]" strokeWidth={1.8} />
            </div>
          </div>
          ...
          <p className="font-body text-base text-white/70 leading-relaxed mb-8">
            ...
            <a
              href="tel:4079901969"
              className="text-[oklch(0.54_0.135_232.9)] font-semibold hover:underline"
            >
              (407) 990-1969
            </a>
            .
          ...
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 font-body font-semibold text-sm px-8 py-3 rounded-full bg-[oklch(0.54_0.135_232.9)] text-white hover:bg-[oklch(0.44_0.135_232.9)] transition-colors duration-200"
          >
            Back to Home
          </Link>
        </div>
